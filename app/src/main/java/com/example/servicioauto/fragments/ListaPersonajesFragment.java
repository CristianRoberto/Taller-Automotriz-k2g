...
import com.example.servicioauto.adapters.PersonajesAdapter;
import com.example.servicioauto.clases.PersonajeVo;
...
public class ListaPersonajesFragment extends Fragment {
    ...
    private void llenarLista() {
        listaPersonaje.add(new PersonajeVo("Kia","Kia Motors es un fabricante surcoreano de automóviles. Su sede central está ubicada en Yangjae-dong, Seocho-gu, Seúl, Corea del Sur.", R.drawable.cambioaceite));
        listaPersonaje.add(new PersonajeVo("Chevrolet","Chevrolet es una marca de automóviles y camiones con sede en Estados Unidos perteneciente al grupo General Motors. Nació de la alianza de Louis Chevrolet y William Crapo Durant el 3 de noviembre de 1911, \u200B en los Estados Unidos, fabricando automóviles robustos. .",R.drawable.cambiocableadoelectrico));
        listaPersonaje.add(new PersonajeVo("Renault Mégane:","siempre ha sido uno de los preferidos de los españoles. Hay un montón de motores donde elegir, tantos como seis: tres de gasolina y otros tres diésel.",R.drawable.cambioaceite));
        listaPersonaje.add(new PersonajeVo("Volkswagen Golf:","La séptima generación del VW Golf está disponible también con una amplia gama de motores, tipos de tracción y cajas de cambios..",R.drawable.cambioaceite));
        listaPersonaje.add(new PersonajeVo(" Tesla Roadster","El Tesla Roadster es un automóvil deportivo totalmente eléctrico, el primer modelo producido",R.drawable.cambioaceite));
