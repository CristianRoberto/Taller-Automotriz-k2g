...
public class ContenedorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(com.example.servicioauto .clases .Utilidades.rotacion==0){
            ...
            com.example.servicioauto.clases.Utilidades.rotacion=1;
        }
    ...
    private void llenarViewPager(ViewPager viewPager) {
        com.example.servicioauto.adapters.SeccionesAdapter adapter=new com.example.servicioauto.adapters.SeccionesAdapter(getFragmentManager());
        adapter.addFragment(new com.example.servicioauto.fragments.GreenFragment(),"VERDE");
        adapter.addFragment(new com.example.servicioauto.fragments.ListaPersonajesFragment(),"LISTA");
